...
<head>
    ...
    <meta property="og:title" content="Avadesh weds Richa" />
    <meta property="og:description" content="We are getting married on 3rd May, 2023" />

    <title>Richa & Avadhesh Wedding</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" style="margin-top: 25em;">
                        ...
                        <h3>May 3rd, 2023 Sadulpur, Rajasthan</h3>
                        <p>We invited you to celebrate our wedding at</p>
                        <p>Agrasen Bhavan, Sadulpur, Churu </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                        <h3>Sneak peak to our Engagement &hearts;</h3>
                    </div>
                </div>
                <div class="couple-wrap animate-box fh5co-heading">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                        <blockquote class="instagram-media" data-instgrm-captioned
                            data-instgrm-permalink="https://www.instagram.com/reel/Cf14IJAjVh9/?utm_source=ig_embed&amp;utm_campaign=loading"
                            data-instgrm-version="14"
                            style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                            <div style="padding:16px;"> <a
                                    href="https://www.instagram.com/reel/Cf14IJAjVh9/?utm_source=ig_embed&amp;utm_campaign=loading"
                                ...
                                <p
                                    ...
                                    <a href="https://www.instagram.com/reel/Cf14IJAjVh9/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                        target="_blank">A post shared by Lalit Sharma (@funlovingcoder)</a></p>
                            </div>
                        </blockquote>
                            ...
                            <div class="wrap-testimony">
                                <div class="owl-carousel-fullwidth">
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <figure>
                                                <img src="images/g-father.jpeg" alt="user">
                                            </figure>
                                            <span><a href="#" class="twitter">Harisharan Sharma(Father)</a></span>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <figure>
                                                <img src="images/g-mother.jpeg" alt="user">
                                            </figure>
                                            <span><a href="#" class="twitter">Kusum Sharma(Mother)</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
